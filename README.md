# Node Express API with MariaDB

A simple Node Express API application and MariaDB, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_node_express_mariadb.git
```

### 2. Navigate to Project Directory
```bash
cd api_node_express_mariadb
```
